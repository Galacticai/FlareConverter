...
import com.galacticai.flareconverter.ui.components.expressive.expressive_card.ExpressiveCard
import com.galacticai.flareconverter.ui.themes.GalacticTheme
import com.galacticai.flareconverter.util.Consistent
import global.common.ui.slider.DiscreteSlider
import global.common.ui.slider.DiscreteSliderOnChange
...
fun <T> ActionDiscreteSlider(
    ...
    ExpressiveActionRow(
        ...
        action = { buttonMod ->
            PercentButton(
                modifier = Modifier.fillMaxHeight() then buttonMod,
        ...
        ExpressiveCard(
            modifier = Modifier.fillMaxHeight() then sliderMod,
