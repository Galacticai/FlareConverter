...
object MediaUtils {
    ...
    /** Get a frame from the given [file] at the given "[from]" ratio and post the results to [live] as [Progressive]s
     * @param from ratio from 0 to 1 (0 = start, 1 = end) */
    private fun postFrame(
        file: File,
        from: Float = .5f,
        live: MutableLiveData<Progressive<File>>,
        mimeCategory: String
    ) {
        live.postValue(Progressive.Pending())
