...
import global.common.IOUtils.children
import java.io.File
...
object IOUtils {
    ...
    fun File.copyToFile(destination: File, overwrite: Boolean = false): Long? {
        Log.d(IOUtils::class.java.name, "Copying $this to $destination")
    ...
    fun File.moveToFile(destination: File, overwrite: Boolean = false): Long? {
        Log.d(IOUtils::class.java.simpleName, "Moving $this to $destination")
    ...
    fun File.deleteAfter(milliseconds: Long) {
        Log.d(IOUtils::class.java.simpleName, "Deleting $this after $milliseconds ms")
    ...
    /** Get the mime type from this [File.extension] */
